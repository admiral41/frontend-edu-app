...
class AdminService {
  ...
  async getApplication(applicationId) {
    return await apiClient.get(`/admin/applications/${applicationId}`);
  }
  ...
  async approveApplication(applicationId) {
    return await apiClient.post(`/admin/applications/${applicationId}/approve`);
  }
  ...
  async rejectApplication(applicationId, reason) {
    return await apiClient.post(`/admin/applications/${applicationId}/reject`, { reason });
  }
