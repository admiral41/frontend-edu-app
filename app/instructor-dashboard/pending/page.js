...
import { Clock, Home, LogOut, Mail, FileText } from "lucide-react";
        ...
        <Card className="shadow-2xl border-0">
          <CardContent className="flex flex-col items-center gap-4 sm:gap-5 p-5 sm:p-8">
            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center">
              <Clock className="h-8 w-8 sm:h-10 sm:w-10 text-amber-600 dark:text-amber-400" />
            </div>

            <div className="text-center space-y-1.5">
              <h1 className="text-xl sm:text-2xl font-bold">Application Under Review</h1>
              <p className="text-muted-foreground text-sm sm:text-base">
                Hi {user?.firstname || "there"}! Your instructor application is being reviewed.
              </p>
            </div>
            ...
            <div className="bg-muted/50 rounded-lg p-3 sm:p-4 w-full">
              ...
              <ul className="text-xs sm:text-sm text-muted-foreground space-y-1.5">
                <li>1. Our team reviews your qualifications and CV</li>
                <li>2. We may contact you for additional info</li>
                <li>3. You'll receive an email once decided</li>
                <li>4. Typical review time: 2-5 business days</li>
              </ul>
            </div>

            <div className="w-full space-y-2 sm:space-y-3 pt-2">
              <a href="mailto:support@padhaihub.com" className="block w-full">
